...
export function ProfileEditor() {
  ...
  const [profileData, setProfileData] = useState<ProfileData>({
    name: user?.name || '',
    nickname: user?.nickname || '', // Ahora el nickname existe en el User
    email: user?.email || '',
    avatar: user?.avatar || '',
    currentPassword: '',
    newPassword: '',
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="profile-image" className="cursor-pointer">
                  <div className="flex items-center space-x-2 px-4 py-2 bg-gray-100 dark:bg-gray-800 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors">
            ...
            {/* Nickname */}
            <div className="space-y-2">
              <Label htmlFor="nickname">Nickname o Alias</Label>
              <Input
                id="nickname"
                type="text"
                value={profileData.nickname}
                onChange={(e) => handleInputChange('nickname', e.target.value)}
                placeholder="Tu nombre de usuario o apodo"
              />
            </div>
